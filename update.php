...
if(isset($_GET['id'])) {
    ...
    if(mysqli_num_rows($result) == 1) {
        ...
        $_SESSION['status'] = "Error: Student not found.";
        $_SESSION['status_code'] = "error";
        header("Location: index.php");
        exit();
    }
} else {
    $_SESSION['status'] = "Error: Student ID not provided.";
    $_SESSION['status_code'] = "error";
    header("Location: index.php");
    exit();
}
            ...
            <form action="process.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth" value="<?php echo $dateOfBirth; ?>">
                    </div>
